...
//  PROC: drawPyramid()
//  DOES: this function
//	  renders a solid pyramid oriented along the z axis.  There are four faces with 
//        each edge lengh one.(constructed out of four triangles with a three sided base)
//
//
//////////////////////////////////////////////////////
void drawPyramid(void)
{
    ...
    glDrawArrays( GL_TRIANGLES, 0, pyraData.numVertices );	
...
void myinit(void)
{
	...
	generatePyramid(program, &pyraData);
...
//float LightPosition[4*10] = {15.0f, 15.0f, 30.0f, 0.0f}; //CHANGES MADE HERE 
